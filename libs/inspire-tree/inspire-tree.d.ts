 ...
 */
declare interface MatchProcessor {
 ...
 */
declare interface SearchMatcher {
...
declare class InspireTree extends EventEmitter2 {
    ...
    load(data: NodeConfig[]): Promise<TreeNodes>;
...
declare class TreeNodes extends Array<TreeNode> {
    addNode(node: NodeConfig): TreeNode;
    available(): TreeNodes;
    blur(): TreeNodes;
    blurDeep(): TreeNodes;
