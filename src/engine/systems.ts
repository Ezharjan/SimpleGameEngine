...
class GameEngineRenderSystem extends GameEngineSystem {
    ...
    private canvasPosition: Vector2 = Vector2.zero;
    private canvasScale = 1;
    public static canvasTransformMatrix: CustomizedMatrix = null;
    ...
    // /**
    //  * 获取缩放矩阵
    //  * @param globalMatrix 原始全局矩阵
    //  */
    // private getscaleMatrix(globalMatrix: CustomizedMatrix): CustomizedMatrix {
    //     return CustomizedMatrix.translateMatrix(new Vector2(RM.canvasWidth / 2, RM.canvasHeight / 2)).mul
    //         (
    //             CustomizedMatrix.scaleMatrix(Vector2.one.mul(this.canvasScale) as Vector2).mul
    //                 (
    //                     CustomizedMatrix.translateMatrix(new Vector2(-RM.canvasWidth / 2, -RM.canvasHeight / 2)).mul
    //                         (
    //                             globalMatrix
    //                         )
    //                 )
    ...
    // /**
    //  * 设置画布变换
    //  * @param transformMatrix 游戏对象变换矩阵
    //  */
    // private setCanvasTransform(transformMatrix: CustomizedMatrix) {
    //     context.setTransform
    //         (
    //             transformMatrix.a,
    //             transformMatrix.c,
...
//  * 游戏引擎编辑器输入系统
//  */
// class GameEngineEditorInputSystem extends GameEngineSystem {
//     /**
//      * 鼠标拖拽事件回调函数
//      * @param deltaPosition 鼠标位置增量
//      */
//     public static onMouseDrag = (deltaPosition: Vector2) => { };
//     /**
//      * 鼠标滚轮事件回调函数
//      * @param deltaWheel 鼠标滚轮增量(-1前滚，1后滚)
//      */
//     public static onWheel = (deltaWheel: number) => { };
//     /**
//      * 鼠标位置
//      */
...
//      * 画布
//      */
//     private canvasPanel: HTMLElement = null;
//     public onStart() {
//         this.canvasPanel = document.getElementById("scenePanel");
//         this.canvasPanel.addEventListener("mousemove", (mouseEvent) => {
//             GameEngineEditorInputSystem.mousePosition = new Vector2(mouseEvent.offsetX, mouseEvent.offsetY);
//         });
//         this.canvasPanel.addEventListener("mousedown", () => {
//             this.isMouseDown = true;
//         });
//         this.canvasPanel.addEventListener("mouseup", () => {
//             this.isMouseDown = false;
//             this.lastPosition = this.currentPosition;
//         });
//         this.canvasPanel.addEventListener("mouseleave", () => {
//             this.isMouseDown = false;
//             this.lastPosition = this.currentPosition;
//         });
//         this.canvasPanel.addEventListener("wheel", (mouseEvent) => {
//             GameEngineEditorInputSystem.onWheel(mouseEvent.deltaY * 0.01);
//         });
//     }
//     private currentPosition: Vector2 = Vector2.zero;
//     private deltaPosition: Vector2 = Vector2.zero;
//     private lastPosition: Vector2 = Vector2.zero;
//     public onFrame() {
//         if (this.isMouseDown) {
//             this.currentPosition = GameEngineEditorInputSystem.mousePosition;
//             this.deltaPosition = this.currentPosition.sub(this.lastPosition);
//             GameEngineEditorInputSystem.onMouseDrag(this.deltaPosition);
//         }
//         this.lastPosition = GameEngineEditorInputSystem.mousePosition;
//     }
// }
...
class AudioSystem extends GameEngineSystem {
    ...
    playAudio(shouldLoop: boolean, audioVolume = this.volume) {
        try {
...
class PrefStorageSystem {
    ...
    updateOne(oldElement: any, newElement: any) {
        // 更新单项
